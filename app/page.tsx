  ...
  return (
    <GatewayShell>
      <main>
        ...
        <footer>
          <span>© {new Date().getFullYear()} B. C. Arsenios</span>
          <a href="mailto:hello@thelastgreatpharaoh.com">Contact</a>
